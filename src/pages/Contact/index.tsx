      ...
      <section className="bg-sand py-16">
        <Container className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-5">
            ...
            <h1 className="text-4xl font-semibold text-slate-900">Start a Crozroad deployment</h1>
            <p className="text-base text-slate-600">
              Tell us about your district, event portfolio, or street commerce goals. Our team will
              respond with a tailored deployment plan within 48 hours.
            </p>
          ...
          >
            ...
            <textarea
              name="message"
              placeholder="Tell us about your access challenges and goals"
