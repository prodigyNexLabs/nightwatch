  ...
  <main className="min-h-screen bg-sand">
    <section className="mx-auto w-full max-w-md px-6 py-12">
      <header className="space-y-4">
        <h1 className="text-3xl font-semibold text-slate-900">Privacy Policy for Crozroad</h1>
      ...
      <div className="mt-6 rounded-[28px] border border-white/70 bg-white/80 p-6 shadow-soft backdrop-blur">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">1. Scope of This Policy</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">5. Data Sharing & Disclosure</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">6. Cross-Border Data Transfers</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">9. App Permissions Disclosure</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">10. Security Measures</h2>
          <p>We implement:</p>
          <ul className="space-y-2">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">12. Third-Party Services & Links</h2>
          <p>We are not responsible for the privacy practices of third-party platforms linked through the App.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">13. Business Transfers</h2>
          <p>
        ...
        <section className="space-y-3">
          ...
          <p>
            We may update this Privacy Policy periodically. Continued use of Crozroad after updates
            constitutes acceptance.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">15. Grievance & Contact Information</h2>
          <p>
          ...
          <p>Grievances will be acknowledged and resolved within legally prescribed timelines.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">16. Acceptance</h2>
          <p>
